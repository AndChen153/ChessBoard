...
class ChessMove:
    def __init__(self):
        ...
        self.SPR = 1600                             # Steps per Rotation (360/1.8)*32
        self.SPS = 1737                             # Steps per Chess Square
        self.HALFSPS = 868                         # Steps per half Chess Square
        ...
        GPIO.output(self.MODE, self.RESOLUTION["1/8"])    # same speed as full step but much quieter
