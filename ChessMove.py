...
def translation(xPlaces, xDirection, yPlaces, yDirection):
    ...
    if xPlaces == yPlaces:
        st1 = threading.Thread(target=stepper_worker, args=(XAxisStepper, xPlaces, dirx, stepStyles[0],))
        st1.start()
        st2 = threading.Thread(target=stepper_worker, args=(YAxisStepper, yPlaces, diry, stepStyles[0],))
        st2.start()
